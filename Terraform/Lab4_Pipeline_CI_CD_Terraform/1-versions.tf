...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-ACE-001"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "terraformsace"      # mettre le nom du compte de stockage créer dans le lab 1
